...
<Tabs syncKey="framework">
  <TabItem label="React" icon="seti:react">
    ```tsx
    import { codeToComponentName, codeToEmoji } from '@sankyu/react-circle-flags'

    // Convert country code to component name (PascalCase)
    codeToComponentName('us') // 'FlagUs'
    codeToComponentName('cn') // 'FlagCn'
  ...
  <TabItem label="Vue 3" icon="seti:vue">
    ```typescript
    import { codeToComponentName, codeToEmoji } from '@sankyu/vue-circle-flags'
  ...
  <TabItem label="Solid">
    ```typescript
    import { codeToComponentName, codeToEmoji } from '@sankyu/solid-circle-flags'
...
<Tabs syncKey="framework">
  <TabItem label="React" icon="seti:react">
    ...
    // Handle flag sizes
    FlagUtils.getSizeName(48)             // "medium"
    FlagUtils.sizes.medium                // 48
    ```
  </TabItem>
  <TabItem label="Vue 3" icon="seti:vue">
    ```typescript
