...
<Tabs syncKey="framework">
  ...
  <TabItem label="Svelte 5">
    All flag components accept standard Svelte SVG attributes:
    ...
    <script lang="ts">
      ...
      let { flagProps = {} }: { flagProps?: SVGAttributes<SVGSVGElement> } = $props()
    </script>
...
<Tabs syncKey="ts-examples">
  ...
  <TabItem label="Svelte 5">
    ...
    <script lang="ts">
      ...
      let props: ComponentProps<typeof FlagUs> = {
        width: 48,
        height: 48,
        title: 'United States',
      }
...
<Tabs syncKey="framework">
  ...
  <TabItem label="Svelte 5">
    ```typescript
    import { coerceFlagCode, isFlagCode } from '@sankyu/svelte-circle-flags'
    import type {
      CountryCode,
      DynamicFlagProps,
      FlagCode,
    ...
    const strictProps: DynamicFlagProps = {
      strict: true,
      code: validCode,
    }

    const safeCode = coerceFlagCode('US')
    const isNormalizedValid = isFlagCode('us')
    ```
...
<Tabs syncKey="framework">
  ...
  <TabItem label="Svelte 5">
    ```typescript
    import { FlagUtils } from '@sankyu/svelte-circle-flags'
...
<Tabs syncKey="framework">
  ...
  <TabItem label="Svelte 5">
    ...
    <script lang="ts">
      ...
      import type { FlagCode } from '@sankyu/svelte-circle-flags'

      let selectedCountry = $state<FlagCode>('us')
    </script>

    <DynamicFlag strict code={selectedCountry} width={32} height={32} />
    <button onclick={() => (selectedCountry = 'us')}>USA</button>
    <button onclick={() => (selectedCountry = 'cn')}>China</button>
    ```
