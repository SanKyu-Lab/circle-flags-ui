...
**[View detailed usage with code examples →](/docs/guides/getting-started/usage/#1-named-imports)**
...
**[View detailed usage with code examples →](/docs/guides/getting-started/usage/#2-dynamicflag)**

## Bundle size comparison

| Method                          | Bundle Size | Tree-shaking     | Loading | Use Case                         |
| ------------------------------- | ----------- | ---------------- | ------- | -------------------------------- |
| **Per-flag imports (3 flags)**  | ~2.8 KB     | ✅ Deterministic | Instant | Known flags at build time        |
| **Per-flag imports (10 flags)** | ~9.5 KB     | ✅ Deterministic | Instant | Common flags header              |
...
- **Each flag component (per-flag subpath):** ~950 bytes (minified)
...
<CardGrid>
  ...
  <Card title="Prefer Offline-first" icon="star">
    Default to per-flag subpath imports. If you must support any runtime code synchronously, use
    DynamicFlag.
  </Card>
</CardGrid>
