...
<html>
  ...
  <body>
    ...
    <script type="module">
      ...
      import { FlagUs } from 'https://esm.sh/@sankyu/react-circle-flags@1?exports=FlagUs'
...
```js
import { FlagCn, FlagUs } from 'https://esm.sh/@sankyu/react-circle-flags@1?exports=FlagCn,FlagUs'
```
...
import {
  ...
  FlagGb,
  FlagUs,
} from 'https://esm.sh/@sankyu/react-circle-flags@1?exports=FlagCn,FlagGb,FlagUs'
