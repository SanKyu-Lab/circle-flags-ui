...
<html>
  ...
  <body>
    ...
    <script type="module">
      ...
      import { FlagUs } from 'https://esm.sh/@sankyu/react-circle-flags@1.5.5?exports=FlagUs'
...
import {
  FlagCn,
  FlagUs,
} from 'https://esm.sh/@sankyu/react-circle-flags@1.5.5?exports=FlagCn,FlagUs'
```
...
import {
  ...
  FlagGb,
  FlagUs,
} from 'https://esm.sh/@sankyu/react-circle-flags@1.5.5?exports=FlagCn,FlagGb,FlagUs'
